  ...
  <view class="login-container">
    ...
    <view class="login-form">
      <view class="form-item">
        ...
        <input
          class="form-input admin-username-input"
          v-model="username"
          placeholder="请输入用户名"
          type="text"
      ...
      <view class="form-item">
        ...
        <input
          class="form-input admin-password-input"
          v-model="password"
          placeholder="请输入密码"
          type="password"
...
// 用户名回车 → 聚焦密码框
const onUsernameConfirm = () => focusField('admin-password-input')
// 密码回车 → 触发登录
...
.login-container {
  min-height: 100vh;
  background: linear-gradient(135deg, #d8c99c 0%, #c9b890 100%);
  padding: $spacing-lg;
  display: flex;
