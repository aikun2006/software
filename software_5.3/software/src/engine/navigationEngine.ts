...
import { findRoute, formatSegmentInstruction, type RouteStep, type RouteSegment, type RoutePreferences } from './pathfinder'
...
export class NavigationEngine {
  ...
  /** 界面语言（'zh'|'en'），影响 nextTurn.instruction 的生成语言 */
  ...
  private buildProgress(): NavProgress {
    ...
    if (this.route && this.currentSegIdx < this.route.segments.length) {
      ...
      nextTurn = {
        ...
        instruction: formatSegmentInstruction(seg, this.lang),
      }
    }
