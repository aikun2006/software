...
export const chatQA: QAItem[] = [
  ...
  { id: 30, question: '灵山梵宫内部参观需要额外购票吗？', questionEn: 'Does Lingshan Palace require extra ticket?', answer: '灵山梵宫包含在大门票内，无需额外购票；每日有圣境展示演出，建议提前到场占座；内部禁止使用闪光灯拍照。', answerEn: 'Lingshan Palace is included in the main ticket, no extra fee. Daily performances available, arrive early for seats. No flash photography inside.' },
  { id: 31, question: '景区有没有轮椅和婴儿车租赁服务？', questionEn: 'Wheelchair and stroller rental available?', answer: '景区游客中心提供轮椅和婴儿车租赁，轮椅免费（押金300元），婴儿车20元/次（押金200元），需出示有效证件登记。', answerEn: 'Visitor Center offers wheelchair (free, 300 RMB deposit) and stroller rental (20 RMB/time, 200 RMB deposit). ID required.' },
  { id: 32, question: '九龙灌浴表演一天有几场？', questionEn: 'How many Nine Dragons Bathing shows per day?', answer: '九龙灌浴每日循环演出，旺季每小时整点一场（9:00-17:00），淡季每两小时一场；表演时长约8分钟，建议提前10分钟到场占位。', answerEn: 'Hourly shows during peak season (9 AM-5 PM), every two hours in off-season. 8-minute show, arrive 10 minutes early for a good spot.' },
  { id: 33, question: '灵山胜境适合什么季节去最好？', questionEn: 'Best season to visit Lingshan?', answer: '春季（3-5月）和秋季（9-11月）气候宜人，是最佳游览季节；夏季较热但梵宫内有空调；冬季人少清幽，适合静心祈福。', answerEn: 'Spring (Mar-May) and Autumn (Sep-Nov) are best. Summer is hot but the Palace is air-conditioned. Winter is quiet, good for meditation and prayer.' },
  { id: 34, question: '景区内有没有ATM取款机或便利店？', questionEn: 'ATMs or convenience stores inside the park?', answer: '景区入口游客中心设有ATM取款机，九龙灌浴广场旁有便利店和自动售货机；建议携带移动支付，景区内大部分商户支持微信/支付宝。', answerEn: 'ATMs at Visitor Center entrance. Convenience stores and vending machines near Nine Dragons Bathing. Mobile payment (WeChat/Alipay) widely accepted.' },
  { id: 35, question: '灵山大佛可以爬上去抱佛脚吗？', questionEn: 'Can I climb up to touch the Buddha feet?', answer: '可以！登216级台阶即可到达莲花座抱佛脚，寓意好运吉祥；台阶较陡，老人小孩建议乘坐电梯（位于佛像左侧，免费使用）。', answerEn: 'Yes! Climb 216 steps to the lotus pedestal to touch the Buddha feet for good luck. Elevator available on the left side (free) for seniors and children.' },
  { id: 36, question: '五印坛城是干什么的，可以进去参观吗？', questionEn: 'What is Five Seal Mandala and can I visit?', answer: '五印坛城是藏传佛教艺术殿堂，展示精美唐卡和藏式建筑；可入内参观，禁止拍照和触摸展品；每日有藏文化讲解服务。', answerEn: 'Five Seal Mandala is a Tibetan Buddhist art hall with thangka paintings and Tibetan architecture. Open to visitors, no photos or touching exhibits. Daily cultural tours available.' },
  { id: 37, question: '灵山景区有没有夜游活动？', questionEn: 'Any night tours at Lingshan?', answer: '夏季特定时段开放夜游，灵山梵宫有灯光秀和夜间祈福活动；拈花湾小镇夜间有禅意灯光秀和水幕电影，建议提前查景区公告。', answerEn: 'Night tours available in summer. Lingshan Palace offers light shows and evening prayer. Nianhuawan Town has Zen light shows and water screen movies. Check park announcements.' },
  { id: 38, question: '景区附近有没有加油站和充电桩？', questionEn: 'Gas stations and EV charging nearby?', answer: '景区入口主干道向北2公里有中石化加油站；停车场内设有新能源充电桩（快充4个、慢充8个），建议非节假日使用避免排队。', answerEn: 'Sinopec gas station 2km north of entrance. EV charging stations in parking lot (4 fast, 8 slow). Use on non-holidays to avoid queues.' },
  { id: 39, question: '带小孩去灵山适合玩什么项目？', questionEn: 'Kid-friendly activities at Lingshan?', answer: '推荐九龙灌浴表演（孩子最爱）、灵山梵宫互动投影、五印坛城藏文化体验、抱佛脚祈福；景区内还有儿童推车友好步道和亲子休息区。', answerEn: 'Recommended for kids: Nine Dragons Bathing show, interactive projections in Lingshan Palace, Tibetan culture experience at Five Seal Mandala, touching Buddha feet. Stroller-friendly paths and family rest areas available.' },
]

const CHAT_DISPLAY = 10
 ...
 * 首页猜你想问轮换逻辑
 * - 固定展示 10 条
 * - 每 60 秒自动轮换：保留前 2 条最高权重，随机替换剩余 8 条
 * - 搭配 0.2s 淡入淡出过渡
 * - 点击问题直接填充输入框并自动发送
...
export function useChatQaRotation() {
  ...
  const initDisplay = () => {
    ...
    const randomExtra = getRandomItems(pool, CHAT_DISPLAY - 2)
    displayed.value = [getQuestion(chatQA[0]), getQuestion(chatQA[1]), ...randomExtra.map(getQuestion)]
  }
