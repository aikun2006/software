...
.main-stat-card {
  background: linear-gradient(135deg, rgba(64, 128, 255, 0.2) 0%, rgba(64, 128, 255, 0.05) 100%);
  border: 2rpx solid rgba(64, 128, 255, 0.3);
...
.point-dot {
  ...
  border-radius: 50%;
  border: 4rpx solid rgba(64, 128, 255, 0.3);
}
...
.bar-fill {
  height: 100%;
  background: linear-gradient(90deg, $primary-color, #00f2fe);
  border-radius: 100rpx;
