...
export const mockRoutes: TourRoute[] = [
  {
    ...
    spots: [
      { id: 'futan', name: '佛足坛', description: '瞻仰佛祖真身脚印，32种吉祥图案祈福', imageUrl: '', duration: 15, order: 1 },
  ...
  },
  {
    ...
    spots: [
      { id: 'futan', name: '佛足坛', description: '祈福朝圣第一站', imageUrl: '', duration: 15, order: 1 },
      ...
      { id: 'manfeilong', name: '飞龙塔', description: '登塔远眺，太湖风光尽收眼底', imageUrl: '', duration: 20, order: 6 },
  ...
  },
  {
    ...
    spots: [
      { id: 'futan', name: '佛足坛', description: '瞻仰佛足，祈福开始', imageUrl: '', duration: 15, order: 1 },
      { id: 'jile-lifo', name: '祈年殿', description: '虔诚祈福，祈愿平安', imageUrl: '', duration: 20, order: 2 },
