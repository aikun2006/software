...
const spots = ref<Spot[]>([
  ...
  },
  {
    ...
    tag: '核心景点',
    tagClass: 'tag-core',
    desc: '灵山大佛脚下朝拜区域，可近距离瞻仰大佛庄严法相',
    fullDesc: '极乐礼佛位于灵山大佛脚下，是游客近距离瞻仰和礼拜大佛的专用区域。在此处仰望88米高的大佛，更能感受到其震撼人心的气势与慈悲。',
    locationInfo: '灵山大佛正下方台阶处',
    tips: '进入此区域需脱帽致敬，保持肃穆；是拍摄大佛合影的最佳机位之一',
    distance: '距入口约1.15km',
    time: '推荐游览15分钟'
  },
  {
  ...
  },
  {
    ...
    tag: '主干道',
    tagClass: 'tag-facility',
    desc: '通往核心景区的中轴主干道，全长约800米',
    fullDesc: '菩提大道是灵山胜境的主轴通道，南起检票口，北至杏坛广场。道路两侧精心布置了园林景观、石雕小品和文化标识牌，漫步其间即可感受浓郁的佛教文化氛围。',
    locationInfo: '连接入口（梵足坛）与杏坛广场的中轴主干道',
    tips: '沿途有各种小吃摊位和纪念品商店；两侧园林景观精美适合边走边拍'
  },
  {
    id: 'futan',
    name: '梵足坛',
