<template>
  <view class="detail-page">
    ...
    <view class="detail-header">
      ...
      <text class="header-title">{{ shop?.name || '住宿详情' }}</text>
    ...
    <scroll-view v-if="shop" class="detail-scroll" scroll-y>
      ...
      <view class="section-card tips-card" v-if="shop.tips">
        <text class="section-title">💡 入住贴士</text>
      ...
      <view class="post-card">
        ...
        <template v-else>
          <text class="login-tip">登录后即可发表评价，分享你的入住感受</text>
...
onLoad((options: any) => {
  ...
  if (!shop.value) {
    uni.showToast({ title: '酒店不存在', icon: 'none' })
